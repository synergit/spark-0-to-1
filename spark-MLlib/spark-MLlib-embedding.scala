...
/* almost the same as spark-MLlib/spark-MLlib-bucketized-features.scala, but not drop fields after StringIndexer, no bucketizing  */

/*
rmse: Double = 53458.297851635536
Root Mean Squared Error (RMSE) on test data = 53458.297851635536
*/