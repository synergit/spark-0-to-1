...
val bucketizer = new Bucketizer().setInputCol(fieldBedroom).setOutputCol(fieldBedroomDiscrete).setSplits(splits)
...
/*
rmse: Double = 42320.837053431926
Root Mean Squared Error (RMSE) on test data = 42320.837053431926
*/