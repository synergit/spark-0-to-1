...
val selector = new UnivariateFeatureSelector().setSelectionThreshold(20).setFeatureType("continuous").setLabelType("categorical").setFeaturesCol("features").setLabelCol("SalePriceInt").setOutputCol("selectedFeatures")
...
val filePath2: String = s"${rootPath}/train.csv"
...
/*
rmse2: Double = 40191.683173409074
Root Mean Squared Error (RMSE) on test data = 40191.683173409074*/